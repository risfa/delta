<?php 
	if(isset($_GET['edit'])){
		$data_edit = mysql_fetch_array(mysql_query("SELECT * FROM news_category WHERE ID_category = '$_GET[edit]'"));
	}
	if(isset($_POST['update'])){
		$sql_udpate = mysql_query("UPDATE news_category SET nama = '$_POST[category_name]' WHERE ID_category = '$_GET[edit]'");
		if($sql_udpate){
	...
	if(isset($_POST['simpan'])){
		$sql_simpan = mysql_query("INSERT INTO `news_category` (`ID_category`, `nama`) VALUES (NULL, ' $_POST[category_name]');");
		if($sql_simpan){
	...
	if(isset($_GET['delete'])){
		$sql_delete= mysql_query("DELETE FROM news_category WHERE ID_category = '$_GET[delete]'");
		if($sql_delete){
	...
	<div class="col-md-4">
		<form method="post">
			<div class="form-group">
				...
				<input type="text" value="<?php echo $data_edit['nama'] ?>" class="form-control" name="category_name">
			</div>
			<div class="form-group">
				<?php if(!$_GET['edit']){ ?>

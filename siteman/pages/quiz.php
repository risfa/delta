...
//DELETE
    if(isset($_GET['delete'])){
      $sqldelete = mysql_query("DELETE FROM quiz WHERE ID_quiz='$_GET[delete]'");
      $id_foto = $_GET['delete'];
      if($sqldelete){

       $filePath = "../../delta_images_assets/quiz/".$id_foto.".jpg";
...
<body>
  <?php
  if(isset($_GET['edit'])){
    $sqledit = mysql_query("SELECT * FROM quiz WHERE ID_quiz='$_GET[edit]'");
  ...
  <div class="row">
    <div  class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"  id="datanya" > 
      <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
        <h1 style="margin-top: 0px; font-weight: bold; margin-left: -2%; margin-bottom: 5%;">QUIZ</h1>
      </div>
      ...
      <table id="example" class="display" cellspacing="0" width="100%">
        ...
        <tbody>
          <?php
          $No = 1;
          $sql = "SELECT * FROM `quiz` ORDER BY post_date  LIMIT 100";
        ...
        <!-- 		<td><a target="blank" href="../bahana_images_assets/news/<?php echo $row['ID'];?>.jpg"><img style="height: 50px; width:50px;" src="../bahana_images_assets/news/<?php echo $row['ID'];?>.jpg"></a></td>
        		<td>
                      ...
                      <?php
                      $filename = "../delta_images_assets/quiz/".$row['ID_quiz'].".jpg";
                      if (!file_exists($filename)) {


                        ?>

                        <td><a target="blank" href="../delta_images_assets/quiz/if_foto_kosong.jpg"><img style="height: 50px; width:50px;" src="../delta_images_assets/quiz/if_foto_kosong.jpg"></a></td>
                        <td>
                          ...
                          ?>
                          <td><a target="blank" href="../delta_images_assets/quiz/<?php echo $row['ID_quiz'];?>.jpg"><img style="height: 50px; width:50px;" src="../delta_images_assets/quiz/<?php echo $row['ID_quiz'];?>.jpg"></a></td>
                          <td>
                          ...
                          <a href="index.php?menu=quiz&edit=<?php echo $row['ID_quiz']?>"><i class="fa fa-pencil"></i>&nbsp;</a> |
                          <a href="index.php?menu=quiz&delete=<?php echo $row['ID_quiz']?>"><i class="fa fa-trash"></i>&nbsp;</a></td>

                          <!-- <td><a target="_blank" href="https://bahanafm.co.id/newsite/pages/news_details.php?details=<?php echo $row['ID_quiz']?>"><i class="fa fa-search"></i>&nbsp;</a></td> -->
                ...
                <div class="container" >
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" id="formnya" style="display: none;">
                      <br>
                      <center><h2>FORM Input Quiz</h2></center>

                      <div> 
                        <!-- FORM INPUT --> 
                        <form enctype="multipart/form-data" class="form-group"  method="post" action="process/add_quiz.php">
                          <!-- <input  name="id_hadiah" value="<?php echo $Data[0]?>"> -->

                          <div id="temp_image"></div>
                          <input  type="hidden" class="form-control" type="text"  value="<?php echo $Data['ID_quiz']?>" name="ID_quiz" placeholder="ID" >
                          <br>
                          <div class="col-md-12">
                            <div class="col-md-4">
                              <label>Title</label>
                              <input class="form-control md-6" type="text" name="post_title" placeholder="Post Title"  required="" value="<?php echo $Data['post_title']?>">
                            </div>
                            <div class="col-md-4">
                              <label>Author</label>
                            ...
                            <!-- <div class="col-md-4">
                              ...
                              <select name="quiz_category_id" class="form-control">
                                <?php  
                                $sql = mysql_query("SELECT * FROM quiz_category");
                                while($data= mysql_fetch_array($sql)){
                                  ?>
                                  <option <?php if($Data['quiz_category_id'] == $data[0]){ ?> selected <?php } ?> value="<?php echo $data[0] ?>"><?php echo $data['quiz_category_name'] ?></option>
                                <?php } ?>
                              </select>
                              <br>
                            ...
                            <!-- <div class="col-md-4">
                             <select data-placeholder="Select tag..." name="tags[]" class="chosen-select" multiple tabindex="4">
                               ...
                               $Check = mysql_query("SELECT tags.id FROM tags JOIN quiz_tags on tags.id = quiz_tags.tags_id where news_tags.news_id = '$id'");
...
<br><br>
                          ...
                          <div class="col-md-12">
                            ...
                            <?php if($_GET['edit']){ ?>
                             ...
                             <a href="index.php?menu=quiz" class="btn btn-danger">CANCEL</a>
                             <?php 
                           }
                           else{ ?>

...
include('../dbconnect.php');
	...
	if(isset($_POST['update'])){
		$sql_udpate = mysql_query("UPDATE bannerSlider SET BannerLink ='$_POST[BannerLink]',rank = '$_POST[urutan]' WHERE idBanner = '$_GET[edit]'");
		$idBannerget = $_GET['edit'];
		if($sql_udpate){

			move_uploaded_file($_FILES["fileToUpload"]["tmp_name"],"../delta_images_assets/slider_assets/".$idBannerget.".jpg");
	...
	if(isset($_POST['simpan'])){
		$sql_simpan = mysql_query("INSERT INTO `bannerSlider` (`idBanner`, `BannerLink`,`rank`) VALUES (null, '$_POST[BannerLink]','$_POST[urutan]'");
		...
		if($sql_simpan){
			...
			move_uploaded_file($_FILES["fileToUpload"]["tmp_name"],"../delta_images_assets/slider_assets/".$data_gambar.".jpg");
	...
	if(isset($_GET['delete'])){
		...
		if($sql_delete){
			        $filePath = "../../delta_images_assets/slider_assets/".$_GET['delete'].".jpg";
...
<div class="data">
	<div class="col-md-4">
		<form method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				<label>Urutan</label>
				<input type="text" value="<?php echo $data_edit['rank'] ?>" class="form-control" name="urutan">
			</div>
			<!-- <div class="form-group">
	 <select name="vission">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<?php
                    $filename = "../delta_images_assets/slider_assets/".$data['idBanner'].".jpg";
                            if (!file_exists($filename)) {
                                

                ?>

                <td><a target="blank" href="../delta_images_assets/slider_assets/if_foto_kosong.jpg"><img style="height: 50px; width:50px;" src="../delta_images_assets/epa/if_foto_kosong.jpg"></a></td>
                <td>
                    ...
                    <?php
                                ...
                                ?>
                <td><a target="blank" href="../delta_images_assets/slider_assets/<?php echo $data['idBanner'];?>.jpg"><img style="height: 50px; width:50px;" src="../delta_images_assets/slider_assets/<?php echo $data['idBanner'];?>.jpg"></a></td>

		...
		<section class="block-wrapper">
			<div class="row" style="background-color: white; padding-top: 1%; padding-bottom: 2%;margin-top: -3%;">
				<div class="col-lg-8 col-md-12">
					...
					$id = mysql_escape_string($_GET['quiz']);
					//echo $id;die();
					if($id == ''){
						// header('Location: http://www.google.com');
						?>
						<script type="text/javascript">
							window.location.replace("quiz_page.php");
							
						</script>
						<?php
					}
					else{
					$query = mysql_query("SELECT * FROM quiz WHERE BINARY post_title = '$id' ");
					...
					$url= urlencode('https://5dapps.com/JOKER/masimanetwork/deltafm/pages/quiz_details.php?quiz=' . $title);
					$image = urlencode('../delta_images_assets/quiz/'. $data['ID_quiz'] .'.jpg');
							...
							<div class="col-12">
								<div class="post-block-style post-grid clearfix">
									...
									<div class="post-thumb">
										<a href="#">
											<img class="img-fluid" src="../delta_images_assets/quiz/<?php echo $data['ID_quiz'] ?>.jpg" alt="" />
										</a>
									</div>
